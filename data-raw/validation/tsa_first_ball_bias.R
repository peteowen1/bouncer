...
print(DBI::dbGetQuery(conn, "
  ...
  FROM main.cricsheet_ball_win_probability
...
print(DBI::dbGetQuery(conn, "
  ...
  FROM main.cricsheet_ball_win_probability WHERE innings_number = 1
  GROUP BY 1,2 ORDER BY 1,2"))
...
print(DBI::dbGetQuery(conn, "
  ...
  FROM main.cricsheet_ball_win_probability WHERE innings_number = 1 GROUP BY 1 ORDER BY 1"))
