...
.stat_rating_params <- function() {
  list(
    ...
    batting_runs                = list(lambda = 0.00042, prior_strength = 100.00),
    batting_fours               = list(lambda = 0.00010, prior_strength = 100.00),
    batting_sixes               = list(lambda = 0.00043, prior_strength = 75.58),
    batting_boundaries          = list(lambda = 0.00022, prior_strength = 100.00),
    batting_dot_balls           = list(lambda = 0.00062, prior_strength = 96.86),
    bowling_runs_conceded       = list(lambda = 0.00340, prior_strength = 100.00),
    bowling_wickets             = list(lambda = 0.00759, prior_strength = 100.00),
    bowling_dot_balls           = list(lambda = 0.00080, prior_strength = 100.00),
    bowling_boundaries_conceded = list(lambda = 0.00040, prior_strength = 100.00),
    bowling_wides               = list(lambda = 0.00051, prior_strength = 100.00),
    batting_wpa                 = list(lambda = 0.01061, prior_strength = 100.00),
    bowling_wpa                 = list(lambda = 0.02644, prior_strength = 98.31),
    batting_era                 = list(lambda = 0.02596, prior_strength = 100.00),
    bowling_era                 = list(lambda = 0.02076, prior_strength = 100.00),
    # Efficiency stats (Beta-Binomial, optimized via multi-start log-loss)
    batting_boundary_rate       = list(lambda = 0.00023, prior_strength = 101.70),
    batting_dot_rate            = list(lambda = 0.00065, prior_strength = 96.95),
    batting_survival_rate       = list(lambda = 0.00026, prior_strength = 118.14),
    bowling_dot_rate            = list(lambda = 0.00056, prior_strength = 127.33),
    bowling_boundary_rate       = list(lambda = 0.00025, prior_strength = 130.97),
    batting_control_rate        = list(lambda = 1e-05, prior_strength = 0.10),
    batting_attack_rate         = list(lambda = 1e-05, prior_strength = 0.10),
    bowling_good_length_rate    = list(lambda = 1e-05, prior_strength = 0.10),
    bowling_on_stump_rate       = list(lambda = 1e-05, prior_strength = 0.10),
    bowling_beat_bat_rate       = list(lambda = 1e-05, prior_strength = 0.10)
  )
}
